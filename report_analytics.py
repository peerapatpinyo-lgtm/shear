...
def render_analytics_section(load_pct, bolt_dia, load_case, factor):
    ...
    Restored: Original V24 Single Beam Graph.
    Logic: Advanced 6-Mode Failure Analysis.
    """
    ...
    for sec in all_sections:
        ...
        # Capacities & Zones (For Graph Plotting)
        h_cm = sec['h'] / 10
        tw_cm = sec['tw'] / 10
        ...
        # Auto-Design Logic (Checking 6 Modes for Safety Ratio)
    ...
    with tab1:
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "Moment Zone": st.column_config.TextColumn("Zone Range", width="small"),
    ...
    # === TAB 2: ORIGINAL SINGLE BEAM GRAPH (Restored) ===
    with tab2:
        ...
        # --- Graph Plotting Logic (Exactly from V24) ---
        V_allow = row['V_Beam']
