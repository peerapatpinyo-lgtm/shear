...
# ==========================================
# MAIN FUNCTION (RESTORED HORIZONTAL VIEW & CLEANED)
# ==========================================
def render_connection_tab(V_design, bolt_size, method, is_lrfd, section_data, conn_type, bolt_grade, T_design=0):
    ...
    # --- CREATE TABS ---
    tab1, tab2 = st.tabs(["📝 Design Inputs & Check", "✏️ Shop Drawing (Compact)"])
    ...
    # ==========================================
    # TAB 2: SHOP DRAWING (HORIZONTAL & COMPACT)
    # ==========================================
    with tab2:
        ...
        # --- VIEW 1: SECTION A-A (TOP VIEW - HORIZONTAL) ---
        with col_sec:
        ...
        # --- VIEW 2: ELEVATION (SIDE VIEW - HORIZONTAL) ---
        with col_elev:
